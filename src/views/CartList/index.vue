...
// 单个商品勾选
const singleChange = (skuId, select) => {
  cartStore.selectChange(skuId.skuId, select)
}

// 所有商品狗狗先
const allChange = (select) => {
  cartStore.selectAll(select)
}

// 删除购物车
const delCart = (i) => {
  cartStore.delCartList(i.skuId)
}
onMounted(() => {
    ...
    <div class="container m-top-20">
            ...
            <tr v-for="i in cartStore.cartList" :key="i.id">
              <td>
                <el-checkbox
                  ...
                  @change="(select) => singleChange(i, select)"
                />
              </td>
              <td>
                <div class="goods">
      ...
      <div class="action">
        <div class="batch">
          ...
          {{ cartStore.selectTotalCount }} 件，商品合计：
          <span class="red">¥{{ cartStore.selectTotalPrice.toFixed(2) }}</span>
        </div>
        <div class="total">
