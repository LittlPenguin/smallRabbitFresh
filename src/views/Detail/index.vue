<script setup>
import { getGoodsDetailAPI } from '@/api/goods.js'
...
const cartStore = useCartCounter()
...
const getGoodsDetail = async () => {
  const {
    data: { result },
  } = await getGoodsDetailAPI(route.params.id)
...
const addCart = () => {
  cartStore.addCart({
    ...
    count: count.value,
    skuId: goodsDetail.value.skus[0].id,
    attrsText: goodsDetail.value.skus[0].specs[0].valueName,
    selected: true,
  })
}
</script>
          ...
          <div class="goods-info">
            <div class="media">
              ...
              <ul class="goods-sales">
                ...
                <li>
                  <p>品牌信息</p>
                  <p>{{ goodsDetail.brand === null ? '无' : goodsDetail.brand.name }}</p>
            ...
            <div class="spec">
              ...
              <el-input-number v-model="count" :min="1" @change="handleChangeCount" />
              <div>
